...
function populateTeams() {
  const teams = [...new Set(data.map(player => player.team))]; // unique teams
  teams.forEach(team => {
...
tableHeaders.forEach((header, index) => {
  header.addEventListener("click", () => {
    const keyMap = ["name", "team", "points", "rebounds", "assists"];
    ...
    sortDirection *= -1; // flip next click direction
...
// Default dropdown value must be "all"
